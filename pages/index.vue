  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6">
    <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
      ...
      <nav class="hidden md:flex space-x-10">
        ...
        <nuxt-link to="spotify" class="text-base leading-6 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
          Spotify
        </nuxt-link>
      ...
      <div class="hidden md:flex items-center justify-end space-x-8 md:flex-1 lg:w-0">
        <nuxt-link to="login" class="whitespace-no-wrap text-base leading-6 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900">
          Sign in
        </nuxt-link>
